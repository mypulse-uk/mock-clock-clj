...
namespace :template do
  ...
  task :populate, [:vault_address, :library_name] do |t, args|
    ...
    Dir["#{directory_location}/**/*"].each do |path|
      ...
      contents = contents.gsub("mock-clock-clj", library_name)
  ...
  task :vault, [:vault_address, :library_name] do |t, args|
      ...
      template_base_path = 'mock-clock-clj'

      library_name = args.library_name.downcase

      puts 'copying value for clojars_deploy_username from mock-clock-clj'
      ...
      puts 'copying value for clojars_deploy_token from mock-clock-clj'
      ...
      puts 'copying value for application_builder_image_repository_url from mock-clock-clj'
      ...
      puts 'copying value for application_builder_image_tag from mock-clock-clj'
      ...
      puts 'copying value for slack_failure_channel from mock-clock-clj'
      ...
      puts 'copying value for slack_failure_message from mock-clock-clj'
      ...
      puts 'copying value for slack_success_channel from mock-clock-clj'
      ...
      puts 'copying value for slack_success_message from mock-clock-clj'
